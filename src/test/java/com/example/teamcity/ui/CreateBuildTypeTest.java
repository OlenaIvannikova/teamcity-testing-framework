...
public class CreateBuildTypeTest extends BaseUITest {
    ...
    public void userCreatesBuildTypeTest() {
        ...
        var createdBuildType = step(
                "Verify build type is created through API",
                () -> superUserCheckRequests
                        .<BuildType>getRequest(Endpoint.BUILD_TYPES)
                        .read(Locator.byName(testData.getBuildType().getName()))
        );
    ...
    public void userCreatesBuildTypeWithoutNameTest() {
        ...
        var buildTypeCountBeforeTest = step("Get build type count before test",
                () ->
                        superUserCheckRequests
                                .<BuildTypes>getRequest(BUILD_TYPES_LIST)
                                .read().getCount()
        );
        ...
        var buildTypeCountAfterTest = step("Verify build type was not created",
                () -> superUserCheckRequests
                        .<BuildTypes>getRequest(BUILD_TYPES_LIST)
                        .read().getCount()
        );
