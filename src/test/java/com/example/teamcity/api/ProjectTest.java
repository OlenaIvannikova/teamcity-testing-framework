...
public class ProjectTest extends BaseApiTest {
    ...
    public void userCreatesProjectTest() {
        ...
        var createdProject = step("Get created project",
                () -> userCheckedRequests
                        .<Project>getRequest(PROJECTS)
                        .read(Locator.byId(testData.getProject().getId()))
        );
    ...
    public void userCreatesProjectWithSqlInjectionPayloadInNameTest() {
        ...
        var createdProject = step("Verify SQL Injection payload is stored as plain text",
                () -> userCheckedRequests
                        .<Project>getRequest(PROJECTS)
                        .read(Locator.byId(testData.getProject().getId()))
        );
    ...
    public void userGetsProjectDetailsByProjectNameTest() {
        ...
        var createdProject = step("Get project details by project name",
                () -> userCheckedRequests
                        .<Project>getRequest(PROJECTS)
                        .read(Locator.byName(testData.getProject().getName()))
        );
